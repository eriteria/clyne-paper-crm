...
export default function CreateUserModal({
  ...
  return (
    <div className="fixed inset-0 bg-white/20 backdrop-blur-sm flex items-center justify-center p-2 md:p-4 z-50">
      <div className="bg-white rounded-lg max-w-[95vw] md:max-w-md w-full max-h-[95vh] md:max-h-[90vh] overflow-y-auto">
